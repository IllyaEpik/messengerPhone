...
import { useConfirmRequestMutation, useGetFriendQuery, useSendRequestMutation } from "../api/friendsApi";
...
export function FriendPage(){
    const { id, action } = useLocalSearchParams<{ id: string, action:friendMenuVariant }>();
    ...
    return (
        <View>
            ...
            <View style={styles.statsContainer}>
                ...
                <View style={styles.statBox}>
                    <Text style={styles.statNumber}>{friend?.readers}</Text>
                ...
                <View style={styles.statBox}>
                    <Text style={styles.statNumber}>{friend?.frieds}</Text>
            ...
            <View style={styles.buttonContainer}>
                ...
                <RegButton
                    ...
                    invisible={true}
                    Buttonstyle={[styles.actionButton, styles.deleteButtonOutline]}
                />
            </View>
            </View>
            <AlbumCard/>
