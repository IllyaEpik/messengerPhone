...
export function FriendMenu(props: friendMenuProps){
    ...
    return(
        <View style={styles.menu}>
            ...
            <Pressable 
                onPress={() => setVariant("requests")}>
            
                <Text 
                style={[
                    styles.text,
                    variant === "requests" ? styles.active : styles.deactive]}> 
                    Запити
                </Text>
            </Pressable>
            
            <Pressable 
                onPress={() => setVariant("recommend")}>
            
                <Text 
                style={[
                    styles.text,
                    variant === "recommend" ? styles.active : styles.deactive]}> 
                    Рекомендації
                </Text>
            </Pressable>
            <Pressable 
                onPress={() => setVariant("all")}>
