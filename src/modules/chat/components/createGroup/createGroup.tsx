...
export function CreateGroupDetails({
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity style={styles.topCloseAction} onPress={onClose}>
        <ICONS.ExitIcon />
      </TouchableOpacity>

      <Text style={styles.mainTitle}>{isEdit ? "Редагування групи" : "Нова група" }</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.participantRowItem}>
            <Avatar image={item.avatar} style={styles.avatar} />
            <Text style={styles.participantLabel}>{item.name}</Text>
      ...
      <View style={styles.footerActionsContainer}>
        ...
        <RegButton 
          ...
          disabled={!groupName}
          onPress={() => onCreate(groupName, participants.map(p => p.id))} 
        />
      </View>
      </View>
      </View>
