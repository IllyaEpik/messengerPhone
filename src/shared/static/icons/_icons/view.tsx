...
export function View(props:SvgProps) {
  return (
    <Svg
      width={20}
      height={20}
      ...
      {...props}
    >
      <G clipPath="url(#clip0_11049_6961)">
        <G
          clipPath="url(#clip1_11049_6961)"
          stroke="#81818D"
          strokeWidth={2}
          strokeLinecap="round"
      ...
      <Defs>
        <ClipPath id="clip0_11049_6961">
          <Path fill="#fff" d="M0 0H20V20H0z" fillOpacity={1} />
        </ClipPath>
        <ClipPath id="clip1_11049_6961">
          <Path fill="#fff" d="M0 0H20V20H0z" fillOpacity={1} />
        </ClipPath>
      </Defs>
    </Svg>
