...
export function Avatar(props: IProps) {
	...
	useEffect(() => {
		if (id){ 
			...
			socket.emit("getUsersOnline", {userIds: [id]}, (ids) => {
				console.log(ids, 11111111111111111111111111111111111111111111, id)
				console.log(ids.onlineUserIds, id, "there must be ok")
	...
	return (
		<View style={[styles.avatarContainer, styles.avatar, style]}> 
			...
			<View style={[!!id && styles.statusBadge, statusBadgeSize, isOnline && styles.activeStatusBadge]} />
		</View>
	);
}
