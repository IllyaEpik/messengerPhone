	...
	return (
		<View style={containerStyles || { flex: 1 }}>
			<View style={{ ...styles.menu, ...menuStyles }}>
				<Pressable onPress={() => setChosen(true)}>
					<Text
						style={[
							styles.text,
							IschosenFirst ? styles.active : styles.deactive,
							textStyles,
						]}
					>
						{firstText}
				...
				<Pressable onPress={() => setChosen(false)}>
					<Text
						style={[
							styles.text,
							IschosenFirst ? styles.deactive : styles.active,
							textStyles,
						]}
					>
						{secondText}
